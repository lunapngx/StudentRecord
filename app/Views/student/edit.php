    ...
    <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body">
                ...
                <form method="POST" action="<?= base_url('student/update/' . $student['student_id']) ?>">
                    <?= csrf_field() ?>
                    <div class="form-group mb-3">
                        <label for="given_name">Given Name</label>
                        <input type="text" class="form-control" id="given_name" name="given_name" value="<?= old('given_name', $student['given_name']) ?>" required>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control" id="year_level" name="year_level" value="<?= old('year_level', $student['year_level']) ?>" required>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="contact_person_name" name="contact_person_name" value="<?= old('contact_person_name', $student['contact_person_name']) ?>" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="contact_person_number">Contact Person Number</label>
                        <input type="text" class="form-control" id="contact_person_number" name="contact_person_number" value="<?= old('contact_person_number', $student['contact_person_number']) ?>" required>
                    </div>
                    <div class="form-group mb-3">
